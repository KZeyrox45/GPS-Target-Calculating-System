...
\centering
\includegraphics[width=0.8\textwidth]{figures/trajectory_pedestrian-kf_ab-synthetic.png}
...
\begin{subfigure}[b]{0.48\textwidth}
\centering
\includegraphics[width=0.9\textwidth]{figures/trajectory_pedestrian-kf_ab-realistic.png}
...
\label{eq:lyapunov-candidate-function-filter}
\end{equation}
