...
\hspace{0.5cm} Kịch bản xe máy có độ lệch chuẩn lớn nhất (Kalman $\sigma = 0{,}37$ m, đo thô $\sigma = 0{,}38$ m), phản ánh tính ngẫu nhiên cao trong quỹ đạo tăng tốc đột ngột theo cả hướng và tốc độ. Ngược lại, kịch bản drone cho độ ổn định cao nhất (đo thô $\sigma = 0{,}08$ m, Alpha-beta $\sigma = 0{,}03$ m) vì nhiễu cảm biến phân phối đồng đều trên cả ba trục và quỹ đạo 3D mượt mà hơn so với xe máy.
